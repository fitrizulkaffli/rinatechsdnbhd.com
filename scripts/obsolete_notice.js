document.addEventListener('DOMContentLoaded', function() {
    ...
    function openPopup() {
        Swal.fire({
            ...
            footer: 'Copyright © 2016&nbsp;<a href="https://fitri.my" target="_blank" rel="noopener noreferrer" class="custom-footer-link">Mohd Fitri Zulkaffli <i class="fa fa-external-link"></i></a>',
