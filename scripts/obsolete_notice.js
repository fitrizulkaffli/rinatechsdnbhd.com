document.addEventListener('DOMContentLoaded', function() {
    ...
    function openPopup() {
        Swal.fire({
            ...
            footer: '<a href="https://fitri.my" target="_blank" rel="noopener noreferrer" class="custom-footer-link">This website was designed by Mohd Fitri Zulkaffli in 2017 <i class="fa fa-external-link"></i></a>',
